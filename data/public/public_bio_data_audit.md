...
| KaNa+/H+ | Paper-reported unversioned `MT473962` with a full-length coding-sequence claim; NCBI resolves `MT473962.1` as a partial CDS | **Not construct-ready** | The paper-versus-repository identity/completeness conflict is explicit; exact topology, localization, transport direction/selectivity, construct, and event mapping remain unresolved. |
...
3. **Missing experimental construct maps.** `AY282755.1`, `DQ146477.2`, and partial-CDS `MT473962.1` are verified repository records, but they do not independently establish the paper's exact targeting, construct, or event mapping. For KaNa+/H+, the paper reports unversioned `MT473962` and calls the cloned material a full-length coding sequence, while NCBI resolves `MT473962.1` as a partial CDS; that identity/completeness conflict must be resolved. The Nemaguard PpHKT1 experimental clone/promoter also remains without a verified accession.
