...
- **Chassis / life stage:** stable transgenic rice cultivar ZH11; the full text reports a recovered homozygous T1 inventory of 12 PyAPX, 11 PyMnSOD, and 9 `KaNa+/H+` lines. These inventory totals are not endpoint experimental sample sizes.
...
- **Sample size:** the germination assay used 30 seeds per dish and three replicate dishes. Endpoint-specific independent-line n for the other reported assays remains `not_reported` in this extraction.
...
- **Accession IDs:** the paper reports PyAPX `AY282755.1`, PyMnSOD `DQ146477.2`, and unversioned `KaNa+/H+` `MT473962`; it calls the cloned KaNa+/H+ material a full-length coding sequence. Guarded NCBI EFetch independently retrieved `AY282755.1` (complete CDS), `DQ146477.2` (complete CDS), and the resolved version `MT473962.1` (partial CDS), with locally calculated SHA-256 hashes in the Phase 2 acquisition receipt.
- **Sequence status:** `accession_verified_construct_map_unresolved`; these repository identities are **not construct-ready**.
- **Key limitation:** the paper-reported accessions and independently verified records do not establish the exact targeting sequences, construct maps, or event-to-construct mappings. The paper's full-length KaNa+/H+ coding-sequence claim conflicts with the partial-CDS state of resolved repository record `MT473962.1`; the identity/completeness conflict remains open. The study also lacks complete multi-ion chemistry and almond Na/Cl/B fate evidence; antioxidant improvement cannot substitute for those outcomes.
