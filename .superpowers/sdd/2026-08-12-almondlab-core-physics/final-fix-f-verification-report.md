...
API tests expanded the final focused suite to 99 tests.
...
- Schema-1 policy objects are revalidated against code-owned immutable values:
  ...
  artifact template, evidence label, and every tolerance.
...
- T19 uses a code-owned six-pair directional EC mismatch oracle.
...
conservation_case_manifest.yaml                f1a551b84808cd5e6af88d27e6ad812099c6ff09d9d550fd019d57f368db9e4f
...
## Final verification after mass Fix G `aa8d303`
...
```text
C:\Users\fowlb\Documents\Codex\2026-08-12\lets\work\wheel-f-final\saltwater_mini_almond-0.1.0-py3-none-any.whl
SHA-256 E2D2B0D333FFE8A296EAC372035C07DA3D8EA91D055652E85D400C917BBFC14E
```
